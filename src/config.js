...
export const PUB_URL = process.env.REACT_APP_PUB_URL || 'http://localhost:5000/pub';
export const WEB_URL = process.env.REACT_APP_WEB_URL || 'http://localhost:3000';

export const SCREENSHOT_COLLECTION = process.env.REACT_APP_SCREENSHOT_COLLECTION || ''

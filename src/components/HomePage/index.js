...
function HomePage() {
  ...
  return (
    <Container fluid style={{ backgroundColor: theme === 'dark' ? 'rgb(37, 36, 36)' : 'rgb(237, 236, 236)', color: theme === 'dark' ? 'white' : 'black', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', height: isMobile ? 'auto' : 'auto', paddingTop: '1rem' }}>
      ...
      <h3 style={{ marginRight: isMobile? 0 : 200, marginLeft: isMobile? 0 : 200, fontFamily: !isMobile ? 'TextFont_1' : '' }}>CharBT is a service focused exclusively on the educational process for traders. Which gives the opportunity to test your skills without risking real funds in a fully simulated environment on historical data.</h3>
